...
-- AddForeignKey
ALTER TABLE `tbl_integration` ADD CONSTRAINT `tbl_integration_queryId_fkey` FOREIGN KEY (`queryId`) REFERENCES `tbl_query`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
