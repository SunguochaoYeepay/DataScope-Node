...
exports.validateCreateDataSource = [
    ...
    (0, express_validator_1.body)('databaseName')
    ...
    (0, express_validator_1.body)('syncFrequency')
        .optional()
        .isIn(validSyncFrequencies).withMessage(`同步频率必须是以下之一: ${validSyncFrequencies.join(', ')}`),
    (0, express_validator_1.body)('connectionOptions')
        .optional()
...
exports.validateSyncMetadata = [
    ...
    (0, express_validator_1.body)('filters.includeSchemas')
        .optional()
        .isArray().withMessage('includeSchemas必须是数组'),
    (0, express_validator_1.body)('filters.excludeSchemas')
        .optional()
        .isArray().withMessage('excludeSchemas必须是数组'),
    (0, express_validator_1.body)('filters.includeTables')
        .optional()
        .isArray().withMessage('includeTables必须是数组'),
    (0, express_validator_1.body)('filters.excludeTables')
        .optional()
