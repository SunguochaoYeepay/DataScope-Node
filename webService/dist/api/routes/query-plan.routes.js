 ...
 *         description: 服务器错误
 */
router.post('/datasource/:dataSourceId', [
    (0, express_validator_1.param)('dataSourceId').isUUID().withMessage('数据源ID必须是有效的UUID'),
    (0, express_validator_1.body)('sql').isString().notEmpty().withMessage('SQL查询不能为空')
 ...
 *         description: 服务器错误
 */
router.post('/query/:queryId/save', [
    (0, express_validator_1.param)('queryId').isUUID().withMessage('查询ID必须是有效的UUID'),
    (0, express_validator_1.body)('plan').isObject().withMessage('plan必须是有效的对象')
 ...
 *         description: 服务器错误
 */
router.get('/query/:queryId/history', [
    (0, express_validator_1.param)('queryId').isUUID().withMessage('查询ID必须是有效的UUID')
 ...
 */
router.get('/:planId', [
    (0, express_validator_1.param)('planId').isUUID().withMessage('计划ID必须是有效的UUID')
