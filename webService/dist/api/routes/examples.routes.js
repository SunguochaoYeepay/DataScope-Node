 ...
 *         description: 服务器错误
 */
router.get('/errors', error_examples_controller_1.errorExamplesIndex);
/**
 * @swagger
 ...
 *         description: 认证错误
 */
router.get('/errors/authentication', error_examples_controller_1.demonstrateAuthenticationError);
/**
 * @swagger
 ...
 *         description: 授权错误
 */
router.get('/errors/authorization', error_examples_controller_1.demonstrateAuthorizationError);
/**
 * @swagger
 ...
 *         description: 应用错误
 */
router.get('/errors/application', error_examples_controller_1.demonstrateAppError);
/**
 * @swagger
 * /examples/success:
 *   get:
 ...
 *         description: 成功响应
 */
router.get('/success', error_examples_controller_1.demonstrateSuccess);
