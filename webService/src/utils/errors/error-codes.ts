...
export const ERROR_MESSAGES: { [key: number]: string } = {
  // 通用错误
  [GENERAL_ERROR.INTERNAL_SERVER_ERROR]: '内部服务器错误',
  [GENERAL_ERROR.INVALID_REQUEST]: '无效的请求',
  [GENERAL_ERROR.VALIDATION_ERROR]: '参数验证错误',
  [GENERAL_ERROR.RESOURCE_NOT_FOUND]: '资源未找到',
  [GENERAL_ERROR.UNAUTHORIZED]: '未授权',
  [GENERAL_ERROR.FORBIDDEN]: '禁止访问',
  [GENERAL_ERROR.METHOD_NOT_ALLOWED]: '方法不被允许',
  [GENERAL_ERROR.REQUEST_TIMEOUT]: '请求超时',
  [GENERAL_ERROR.CONFLICT]: '资源冲突',
  [GENERAL_ERROR.RESOURCE_CONFLICT]: '资源冲突',
  [GENERAL_ERROR.TOO_MANY_REQUESTS]: '请求过多，请稍后再试',
  [GENERAL_ERROR.SERVICE_UNAVAILABLE]: '服务暂时不可用',
  [GENERAL_ERROR.UNKNOWN_ERROR]: '未知错误',
  
  // 数据源错误
  [DATASOURCE_ERROR.CONNECTION_FAILED]: '数据源连接失败',
  [DATASOURCE_ERROR.INVALID_CREDENTIALS]: '数据源凭证无效',
  [DATASOURCE_ERROR.DATABASE_NOT_FOUND]: '数据库未找到',
  [DATASOURCE_ERROR.INVALID_HOST]: '无效的数据源主机地址',
  [DATASOURCE_ERROR.TIMEOUT]: '数据源连接超时',
  [DATASOURCE_ERROR.ALREADY_EXISTS]: '数据源已存在',
  [DATASOURCE_ERROR.NOT_FOUND]: '数据源不存在',
  [DATASOURCE_ERROR.SYNC_FAILED]: '数据源同步失败',
  [DATASOURCE_ERROR.TEST_FAILED]: '数据源连接测试失败',
  [DATASOURCE_ERROR.UNSUPPORTED_TYPE]: '不支持的数据源类型',
  [DATASOURCE_ERROR.DATASOURCE_ERROR]: '数据源错误',
  [DATASOURCE_ERROR.AUTHENTICATION_FAILED]: '数据源认证失败',
  [DATASOURCE_ERROR.DATASOURCE_NOT_FOUND]: '数据源不存在',
  [DATASOURCE_ERROR.INVALID_DATASOURCE_CONFIG]: '数据源配置无效',
  [DATASOURCE_ERROR.UNSUPPORTED_DATASOURCE_TYPE]: '不支持的数据源类型',
  [DATASOURCE_ERROR.DATASOURCE_TIMEOUT]: '数据源操作超时',
  
  // 查询执行错误
  [QUERY_ERROR.EXECUTION_FAILED]: '查询执行失败',
  [QUERY_ERROR.SYNTAX_ERROR]: 'SQL语法错误',
  [QUERY_ERROR.TIMEOUT]: '查询执行超时',
  [QUERY_ERROR.ACCESS_DENIED]: '查询访问被拒绝',
  [QUERY_ERROR.RESULT_TOO_LARGE]: '查询结果集过大',
  [QUERY_ERROR.INVALID_PARAMETERS]: '查询参数无效',
  [QUERY_ERROR.TRANSACTION_ERROR]: '事务处理错误',
  [QUERY_ERROR.QUERY_NOT_FOUND]: '查询未找到',
  [QUERY_ERROR.INVALID_SQL]: '无效的SQL语句',
  [QUERY_ERROR.QUERY_EXECUTION_ERROR]: '查询执行错误',
  [QUERY_ERROR.QUERY_SYNTAX_ERROR]: 'SQL语法错误',
  [QUERY_ERROR.QUERY_TIMEOUT]: '查询执行超时',
  [QUERY_ERROR.QUERY_PERMISSION_DENIED]: '无权执行此查询',
  [QUERY_ERROR.QUERY_RESOURCE_NOT_FOUND]: '查询的资源不存在',
  [QUERY_ERROR.QUERY_TOO_COMPLEX]: '查询过于复杂',
  [QUERY_ERROR.QUERY_RESULT_TOO_LARGE]: '查询结果过大',
  
  // 数据库错误
  [DATABASE_ERROR.DATABASE_ERROR]: '数据库错误',
  [DATABASE_ERROR.DATABASE_CONNECTION_ERROR]: '数据库连接错误',
  [DATABASE_ERROR.DATABASE_QUERY_ERROR]: '数据库查询错误',
  [DATABASE_ERROR.DATABASE_TRANSACTION_ERROR]: '数据库事务错误',
  [DATABASE_ERROR.DATABASE_RECORD_NOT_FOUND]: '数据库记录未找到',
  [DATABASE_ERROR.DATABASE_RECORD_EXISTS]: '数据库记录已存在',
  [DATABASE_ERROR.DATABASE_CONSTRAINT_ERROR]: '数据库约束错误',
  [DATABASE_ERROR.DATABASE_MIGRATION_ERROR]: '数据库迁移错误',
  [DATABASE_ERROR.DATABASE_TIMEOUT]: '数据库操作超时',
  [DATABASE_ERROR.DATABASE_PERMISSION_ERROR]: '数据库权限错误',
  
  // 验证错误
  [VALIDATION_ERROR.VALIDATION_ERROR]: '验证错误',
  [VALIDATION_ERROR.REQUIRED_FIELD_MISSING]: '必填字段缺失',
  [VALIDATION_ERROR.INVALID_FIELD_TYPE]: '字段类型无效',
  [VALIDATION_ERROR.INVALID_FIELD_LENGTH]: '字段长度无效',
  [VALIDATION_ERROR.INVALID_FIELD_FORMAT]: '字段格式无效',
  [VALIDATION_ERROR.INVALID_FIELD_VALUE]: '字段值无效',
  [VALIDATION_ERROR.INVALID_FIELD_RANGE]: '字段范围无效',
  [VALIDATION_ERROR.VALIDATION_FAILED]: '验证失败',
