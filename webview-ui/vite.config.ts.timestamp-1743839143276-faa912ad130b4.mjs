...
var vite_config_default = defineConfig(({ mode }) => {
  ...
  return {
    ...
    // 使用一个全新的缓存目录
    cacheDir: "node_modules/.vite_fresh_cache",
    // 禁止注入额外的客户端代码
    define: {
      // 确保不会有额外的热更新代码被注入
      "__VUE_HMR_RUNTIME__": "{}",
      "process.env.__VUE_HMR_RUNTIME__": "{}"
    }
  };
});
export {
